...
class EmailChangeController extends Controller
{
    ...
    public function confirm(EmailChangeRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            return $this->redirectWithError('An error occurred while confirming the email change. Please try again or contact support.');
        }
    }
    ...
    public function deny(EmailChangeRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            // Return generic error to user to prevent information disclosure
            return $this->redirectWithError('An error occurred while denying the email change. Please try again or contact support.');
        }
    }
    ...
    protected function handleSuccessfulConfirmation(EmailChange $emailChange): RedirectResponse
    {
        ...
        return $this->getSuccessRedirect()
            ->with('success', 'Email change confirmed successfully.');
    }
    ...
    {
        return $this->getSuccessRedirect()
            ->with('success', 'Email change request has been denied successfully.');
    }
    ...
    public function requestChange(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return back()->with('success', 'Email change request submitted. Please check your current email for confirmation instructions.');
        } catch (\Exception $e) {
            // Log the full error for debugging
            ...
            // Return generic error to user to prevent information disclosure
            return back()->withErrors(['email' => 'Unable to process email change request. Please try again or contact support.']);
        }
    }
    ...
    public function cancelPending(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            // Return generic error to user to prevent information disclosure
            return back()->withErrors(['error' => 'Failed to cancel pending email changes. Please try again or contact support.']);
        }
    }
