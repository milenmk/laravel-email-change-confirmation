...
use [the discussions](https://github.com/milenmk/laravel-email-change-confirmation/discussions)
section.

Issues are managed on [GitHub](https://github.com/milenmk/laravel-email-change-confirmation/issues).
...
1. [Fork](https://help.github.com/articles/fork-a-repo)
   the [GitHub repository](https://github.com/milenmk/laravel-email-change-confirmation).
2. Clone your fork.
...
the [Packages documentation site](https://minkov.dev/laravel-email-change-confirmation/documentation).
